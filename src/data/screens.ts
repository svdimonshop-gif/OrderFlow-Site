...
export const screens: AppScreen[] = [
  ...
  },
  {
    ...
    description: {
      ru: "Профиль, личная статистика, тема, язык, уведомления, подключение и память.",
      ua: "Профіль, особиста статистика, тема, мова, сповіщення, підключення та пам’ять."
    },
    width: 1192,
    height: 2560
  },
  {
    ...
    title: { ru: "Личные результаты", ua: "Особисті результати" },
    shortTitle: { ru: "Результаты", ua: "Результати" },
    alt: { ru: "Личная статистика сотрудника за выбранный месяц", ua: "Особиста статистика співробітника за вибраний місяць" },
    description: {
      ru: "Сумма, количество собранных заказов по диапазонам и штрафы за выбранный месяц.",
      ua: "Сума, кількість зібраних замовлень за діапазонами та штрафи за вибраний місяць."
    },
    width: 1191,
    height: 2560
  },
